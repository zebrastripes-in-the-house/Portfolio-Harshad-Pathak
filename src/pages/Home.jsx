...
import img01CardBg from '../assets/01-card-bg.png';
      ...
      <BentoGrid>
        ...
        >
          <div 
            ...
            style={{
              backgroundImage: `url(${img01CardBg})`,
              backgroundSize: 'cover',
              backgroundPosition: 'center',
              backgroundRepeat: 'no-repeat'
            }}
          >
             <h1 className="profile-heading">Harshad Pathak</h1>
             <p className="profile-text">
               I specialize in UI/UX, Graphic and Brand Design, with growing interest in Full-Stack Development. Based in Gandhinagar, Gujarat, India.
               {"\n\n"}
               I am a Sophomore pursuing B.tech (Computer Science Engineering) at IIIT Vadodara (Gandhinagar Campus).
               {"\n\n"}
        ...
        {/* 04: Feature Work (Wide) - LINK TO WORK PAGE */}
        <BentoItem 
           colSpan={2} 
           rowSpan={1} 
           src={img04} 
